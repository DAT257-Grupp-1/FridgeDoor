document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayCocktail(cocktail) {
        ...
        if (cocktail) {
            ...
            ingredientsList.style.listStyleType = 'none'; // Optional styling to remove bullet points
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (ingredient) {
                    ...
                    listItem.textContent = `${measure ? measure : ''} ${ingredient}`; // Include measurement if available
